...
def test_read_valid(example_wheel):
    """Ensure metadata is correctly read from a valid wheel file."""
...
def test_read_non_existent_wheel_file_name():
    """Read a wheel file which doesn't exist and raise an exception."""
...
def test_read_invalid_wheel_extension():
    """Read a wheel file without the valid .whl extension and raise an exception."""
...
def test_read_wheel_empty_metadata(tmpdir):
    """Read a wheel file with empty METADATA and raise an exception."""
