...
def test_read_valid(example_wheel):
    """Read metadata from a valid wheel file."""
...
def test_read_non_existent_wheel_file_name():
    """Raise an exception on reading a wheel file which doesn't exist."""
...
def test_read_invalid_wheel_extension():
    """Raise an exception on reading a wheel file without a .whl extension."""
...
def test_read_wheel_empty_metadata(tmpdir):
    """Raise an exception reading a wheel file with an empty METADATA file."""
